...
public @interface Mod {
     ...
     * <p>
     * This is ignored if there is a {@code NetworkCheckHandler} annotation on a method in this class.
     *
     * @return A version range as specified by the maven version range specification or the empty string
     */
    @AvailableBefore(MinecraftVersion.V1_12)
     ...
     *
     * Advanced users can specify a {@code SaveInspectionHandler} instead.
     * @return A version range as specified by the maven version range specification or the empty string
     */
    @AvailableBefore(MinecraftVersion.V1_12)
     ...
     * <p>
     * Any incorrectness of the fingerprint, be it missing or wrong, will result in the {@code FMLFingerprintViolationEvent}
     ...
     * public zero variable constructor and implement {@code ILanguageAdapter} just like the Java and Scala adapters.
     * <p>
     * A class with an invalid constructor or that doesn't implement {@code ILanguageAdapter} will throw an exception and
     * halt loading.
     *
    ...
    /**
     * An optional GUI factory for this mod. This is the name of a class implementing {@code IModGuiFactory} that will be instantiated
     * on the client side, and will have certain configuration/options guis requested from it.
     *
     * @return The name of a class implementing {@code IModGuiFactory}
     */
    @AvailableBefore(MinecraftVersion.V1_12)
     ...
     * <ul>
     * <li> {@code FMLPreInitializationEvent} : Run before anything else. Read your config, create blocks,
     * items, etc, and register them with the {@code GameRegistry}.</li>
     * <li> {@code FMLInitializationEvent} : Do your mod setup. Build whatever data structures you care about. Register recipes,
     * send {@code FMLInterModComms} messages to other mods.</li>
     * <li> {@code FMLPostInitializationEvent} : Handle interaction with other mods, complete your setup based on this.</li>
     * </ul>
     ...
     * <ul>
     * <li> {@code FMLServerAboutToStartEvent} : Use if you need to handle something before the server has even been created.</li>
     * <li> {@code FMLServerStartingEvent} : Do stuff you need to do to set up the server. register commands, tweak the server.</li>
     * <li> {@code FMLServerStartedEvent} : Do what you need to with the running server.</li>
     * <li> {@code FMLServerStoppingEvent} : Do what you need to before the server has started it's shutdown sequence.</li>
     * <li> {@code FMLServerStoppedEvent} : Do whatever cleanup you need once the server has shutdown. Generally only useful
     * on the integrated server.</li>
     * </ul>
     * The second set of events are more specialized, for receiving notification of specific
     * information.
     * <ul>
     * <li> {@code FMLFingerprintViolationEvent} : Sent just before {@code FMLPreInitializationEvent}
     * if something is wrong with your mod signature</li>
     * <li> {@code IMCEvent} : Sent just after {@code FMLInitializationEvent} if you have IMC messages waiting
     * from other mods</li>
     * </ul>
     */
    @AvailableBefore(MinecraftVersion.V1_12)
    ...
    @interface EventBusSubscriber {
        ...
        // this class doesn't have a javadoc
        @AvailableAfter(MinecraftVersion.V1_13)
        enum Bus {
            /**
             ...
             * See also: {@code FMLJavaModLoadingContext#getModBusGroup()}.
             */
            MOD,
